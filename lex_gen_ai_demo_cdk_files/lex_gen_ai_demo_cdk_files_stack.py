...
class LexGenAIDemoFilesStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        # Import Polly managed policy
        polly_managed_policy = iam.ManagedPolicy.from_aws_managed_policy_name("AmazonPollyFullAccess")

# Attach the Polly managed policy to the Lex IAM role
        lex_cfn_role.add_managed_policy(polly_managed_policy)
        ...
        lambda_cfn_role.add_managed_policy(iam.ManagedPolicy.from_aws_managed_policy_name("AmazonPollyFullAccess"))
