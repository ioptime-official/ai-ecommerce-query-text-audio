...
Invalid Lambda Response: Received invalid response from Lambda: Cannot construct instance of `IntentResponse`, problem: IntentState cannot be ReadyForFulfillment when DialogActionType is not Delegate. at [Source: (String)"{"sessionState": {"sessionAttributes": {}, "dialogAction": {"type": "Close"}, "intent": {"confirmationState": "None", "name": "FallbackIntent", "slots": {}, "state": "ReadyForFulfillment"}}, "messages": [{"contentType": "PlainText", "content": "I'm sorry, but I am only able to give responses regarding the source topic"}, {"contentType": "SSML", "content": "/tmp/response_audio.mp3"}], "requestAttributes": null}"; line: 1, column: 413]