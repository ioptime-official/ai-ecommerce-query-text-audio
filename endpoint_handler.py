...
SAGEMAKER_ENDPOINT_NAME = "huggingface-pytorch-sagemaker-endpoint61"
...
def create_endpoint_from_HF_image(hf_model_id, instance_type="ml.g5.2xlarge", endpoint_name=SAGEMAKER_ENDPOINT_NAME, number_of_gpu=1):
