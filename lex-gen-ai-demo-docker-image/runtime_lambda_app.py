...
# PINECONE_API_KEY = os.environ.get('PINECONE_API_KEY', '0993d7c4-70f3-4aa3-9b26-87010a8d2f1d')
# PINECONE_API_ENV = os.environ.get('PINECONE_API_ENV', 'gcp-starter')

# embeddings=HuggingFaceEmbeddings(model_name='sentence-transformers/all-MiniLM-L6-v2')
# pinecone.init(
# 	api_key='0993d7c4-70f3-4aa3-9b26-87010a8d2f1d',
...
def handler(event, context):
    ...
    #     aws_access_key_id=response["Credentials"]["AKIA3LQETUJPPKGOWRV5"],
    #     aws_secret_access_key=response["Credentials"]["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"],
...
#     logger.info("inside the statement")
...
#         logger.info('-----response in the content function')
